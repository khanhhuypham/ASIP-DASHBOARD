...
const outputFile = './dist/trackasia-gl.d.ts';
childProcess.execSync(`dts-bundle-generator --umd-module-name=trackasiagl -o ${outputFile} ./src/index.ts`);
...
console.log('Finifhed bundling types for trackasia-gl ');
