...
export declare class LngLat {
	 ...
	 * @example
	 * var new_york = new trackasiagl.LngLat(-74.0060, 40.7128);
	 * var los_angeles = new trackasiagl.LngLat(-118.2437, 34.0522);
 ...
 * @see [Add an animated icon to the map.](https://docs.track-asia.com/example/add-image-animated/)
 *
 * @example
 * var flashingSquare = {
 *     width: 64,
...
export declare class LngLatBounds {
	 ...
	 * @example
	 * var llb = new trackasiagl.LngLatBounds(
	 *   new trackasiagl.LngLat(-73.9876, 40.7661),
	 *   new trackasiagl.LngLat(-73.9397, 40.8002)
	 * );
	 *
	 * var ll = new trackasiagl.LngLat(-73.9567, 40.7789);
	 *
	 ...
	 * @example
	 * var center = new trackasiagl.LngLat(-73.9749, 40.7736);
	 * trackasiagl.LngLatBounds.fromLngLat(100).toArray(); // = [[-73.97501862141328, 40.77351016847229], [-73.97478137858673, 40.77368983152771]]
	 */
 ...
 *   padding: 20
 * });
 * @see [Fit to the bounds of a LineString](https://docs.track-asia.com/example/zoomto-linestring/)
 * @see [Fit a map to a bounding box](https://docs.track-asia.com/example/fitbounds/)
 */
 ...
 *
 * @example
 * map.setStyle('https://docs.track-asia.com/demotiles/style.json', {
 ...
 *   container: 'map',
 *   style: 'https://docs.track-asia.com/demotiles/style.json',
 *   center: [-73.5804, 45.53483],
 *   pitch: 60,
 *   bearing: -60,
 *   zoom: 10
 * });
 * @see [Set pitch and bearing](https://docs.track-asia.com/example/set-perspective/)
 * @see [Jump to a series of locations](https://docs.track-asia.com/example/jump-to/)
 * @see [Fly to a location](https://docs.track-asia.com/example/flyto/)
 * @see [Display buildings in 3D](https://docs.track-asia.com/example/3d-buildings/)
 */
...
declare abstract class Camera extends Evented {
	 ...
	 * @fires moveend
	 * @returns {Map} `this`
	 * @see [Navigate the map with game-like controls](https://docs.track-asia.com/example/game-controls/)
	 */
	 ...
	 * @see [Update a feature in realtime](https://docs.track-asia.com/example/live-update-feature/)
	 */
	 ...
	 * });
	 * @see [Fly to a location](https://docs.track-asia.com/example/flyto/)
	 * @see [Slowly fly to a location](https://docs.track-asia.com/example/flyto-options/)
	 * @see [Fly to a location based on scroll position](https://docs.track-asia.com/example/scroll-fly-to/)
	 */
 ...
 * - `'style'`: The [style](https://docs.track-asia.com/style/) used by the map
 *
 ...
 * @property {Object} [source] The [style spec representation of the source](https://docs.track-asia.com/style/#sources) if the event has a `dataType` of `source`.
 ...
 * @example
 * // Initialize the map
 * var map = new trackasiagl.Map({ // map options });
 ...
 * });
 * @see [Create a draggable point](https://docs.track-asia.com/example/drag-a-point/)
 */
"mousedown"
/**
 ...
 * });
 * @see [Get coordinates of the mouse pointer](https://docs.track-asia.com/example/mouse-position/)
 * @see [Highlight features under the mouse pointer](https://docs.track-asia.com/example/hover-styles/)
 * @see [Display a popup on hover](https://docs.track-asia.com/example/popup-on-hover/)
 */
 | "mouseover"
/**
 ...
 * @see [Get coordinates of the mouse pointer](https://docs.track-asia.com/example/mouse-position/)
 * @see [Highlight features under the mouse pointer](https://docs.track-asia.com/example/hover-styles/)
 * @see [Display a popup on over](https://docs.track-asia.com/example/popup-on-hover/)
 */
 | "mousemove"
/**
 ...
 * });
 * @see [Measure distances](https://docs.track-asia.com/example/measure/)
 * @see [Center the map on a clicked symbol](https://docs.track-asia.com/example/center-on-symbol/)
 */
 | "click"
/**
 ...
 * });
 * @see [Center the map on a clicked symbol](https://docs.track-asia.com/example/center-on-symbol/)
 * @see [Display a popup on click](https://docs.track-asia.com/example/popup-on-click/)
 */
 | "mouseenter"
/**
 ...
 * });
 * @see [Display HTML clusters with custom properties](https://docs.track-asia.com/example/cluster-html/)
 */
 | "move"
/**
 ...
 * });
 * @see [Create a draggable marker](https://docs.track-asia.com/example/drag-a-marker/)
 */
 | "dragend"
/**
 ...
 * });
 * @see [Draw GeoJSON points](https://docs.track-asia.com/example/geojson-markers/)
 * @see [Add live realtime data](https://docs.track-asia.com/example/live-geojson/)
 * @see [Animate a point](https://docs.track-asia.com/example/animate-point-along-line/)
 */
 | "load"
/**
 ...
 * });
 * @see [Generate and add a missing icon to the map](https://docs.track-asia.com/example/add-image-missing-generated/)
 */
 | "styleimagemissing"
/**
 * @event style.load
...
export declare class Map extends Camera {
	 ...
	 * @see [Display map navigation controls](https://docs.track-asia.com/example/navigation/)
	 */
	 ...
	 *
	 * @param {number | null | undefined} minPitch The minimum pitch to set (0-85). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the TrackAsia project.
	 ...
	 *
	 * @param {number | null | undefined} maxPitch The maximum pitch to set (0-85). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the TrackAsia project.
	 ...
	 * @see [Render world copies](https://docs.track-asia.com/example/render-world-copies/)
	 */
	 ...
	 * @returns {Map} `this`
	 */
	setCooperativeGestures(gestureOptions?: GestureOptions | boolean | null): this;
	/**
	 ...
	 *     source: {
	 *       type: 'vector',
	 *       url: 'https://docs.track-asia.com/style/'
	 *     },
	 ...
	 *     .addTo(map);
	 * });
	 * @see [Display popup on click](https://docs.track-asia.com/example/popup-on-click/)
	 * @see [Center the map on a clicked symbol](https://docs.track-asia.com/example/center-on-symbol/)
	 * @see [Create a hover effect](https://docs.track-asia.com/example/hover-styles/)
	 * @see [Create a draggable marker](https://docs.track-asia.com/example/drag-a-point/)
	 */
	 ...
	 * @param {Array<string>} [options.layers] (optional) An array of [style layer IDs](https://docs.track-asia.com/style/#layer-id) for the query to inspect.
	 * Only features within these layers will be returned. If this parameter is undefined, all layers will be checked.
	 * @param {FilterSpecification} [options.filter] (optional) A [filter](https://docs.track-asia.com/style/layers/#filter)
	 * to limit query results.
	 * @param {Array<string>} [options.availableImages] (optional) An array of string representing the available images
	 * @param {boolean} [options.validate=true] (optional) Whether to check if the [options.filter] conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 *
	 ...
	 * @see [Get features under the mouse pointer](https://docs.track-asia.com/example/queryrenderedfeatures/)
	 */
	 ...
	 * @param {Array} [parameters.filter] A [filter](https://docs.track-asia.com/style/layers/#filter)
	 * to limit query results.
	 * @param {boolean} [parameters.validate=true] Whether to check if the [parameters.filter] conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 *
	 * @returns {Array<MapGeoJSONFeature>} An array of MapGeoJSONFeature objects.
	 *
	 ...
	 * [TrackAsia Style Specification](https://docs.track-asia.com/style/), or a URL to such JSON.
	 * @param {Object} [options] Options object.
	 ...
	 * TrackAsia Style Specification's [source definition](https://docs.track-asia.com/style/#sources) or
	 ...
	 *   type: 'vector',
	 *   url: 'https://docs.track-asia.com/demotiles/tiles/tiles.json'
	 * });
	 * @example
	 * map.addSource('my-data', {
	 *   "type": "geojson",
	 ...
	 *   }
	 * });
	 * @see GeoJSON source: [Add live realtime data](https://docs.track-asia.com/example/live-geojson/)
	 */
	 ...
	 * [Sources](https://docs.track-asia.com/style/sources/) page.
	 * @example
	 ...
	 * [`icon-image`](https://docs.track-asia.com/style/#layout-symbol-icon-image),
	 * [`background-pattern`](https://docs.track-asia.com/style/#paint-background-background-pattern),
	 * [`fill-pattern`](https://docs.track-asia.com/style/#paint-fill-fill-pattern),
	 * or [`line-pattern`](https://docs.track-asia.com/style/#paint-line-line-pattern).
	 ...
	 *
	 *
	 * @see Use `HTMLImageElement`: [Add an icon to the map](https://docs.track-asia.com/example/add-image/)
	 * @see Use `ImageData`: [Add a generated icon to the map](https://docs.track-asia.com/example/add-image-generated/)
	 */
	 ...
	 * });
	 *
	 * @see [Add an icon to the map](https://docs.track-asia.com/example/add-image/)
	 */
	...
	listImages(): string[];
	/**
	 * Adds a [TrackAsia style layer](https://docs.track-asia.com/style/#layers)
	 * to the map's style.
	 *
	 * A layer defines how data from a specified source will be styled. Read more about layer types
	 * and available paint and layout properties in the [TrackAsia Style Specification](https://docs.track-asia.com/style/#layers).
	 *
	 ...
	 * @param {Object} layer
	 * conforming to either the TrackAsia Style Specification's [layer definition](https://docs.track-asia.com/style/#layers) or,
	 ...
	 * A list of layer types is available in the [TrackAsia Style Specification](https://docs.track-asia.com/style/layers/#type).
	 *
	 ...
	 * Reference a _new source_ using a source object (as defined in the [TrackAsia Style Specification](https://docs.track-asia.com/style/sources/)) directly.
	 ...
	 * The TrackAsia Style Specification includes more information on the limitations of the [`filter`](https://docs.track-asia.com/style/layers/#filter) parameter
	 * and a complete list of available [expressions](https://docs.track-asia.com/style/expressions/).
	 ...
	 * A full list of paint properties for each layer type is available in the [TrackAsia Style Specification](https://docs.track-asia.com/style/layers/).
	 ...
	 * A full list of layout properties for each layer type is available in the [TrackAsia Style Specification](https://docs.track-asia.com/style/layers/).
	 ...
	 * }, 'cities');
	 *
	 * @see [Create and style clusters](https://docs.track-asia.com/example/cluster/)
	 * @see [Add a vector tile source](https://docs.track-asia.com/example/vector-source/)
	 * @see [Add a WMS source](https://docs.track-asia.com/example/wms/)
	 */
	 ...
	 *
	 * @see [Filter symbols by toggling a list](https://docs.track-asia.com/example/filter-markers/)
	 * @see [Filter symbols by text input](https://docs.track-asia.com/example/filter-markers-by-input/)
	 */
	getLayer(id: string): StyleLayer;
	/**
	 * Sets the zoom extent for the specified style layer. The zoom extent includes the
	 * [minimum zoom level](https://docs.track-asia.com/style/#layer-minzoom)
	 * and [maximum zoom level](https://docs.track-asia.com/style/#layer-maxzoom))
	 ...
	 * [filter definition](https://docs.track-asia.com/style/layers/#filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
	 * @param {Object} [options] Options object.
	 * @param {boolean} [options.validate=true] Whether to check if the filter conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @returns {Map} `this`
	 *
	 * @example
	 ...
	 *
	 * @see [Create a timeline animation](https://docs.track-asia.com/example/timeline-animation/)
	 */
	 ...
	 * Must be of a type appropriate for the property, as defined in the [TrackAsia Style Specification](https://docs.track-asia.com/style/).
	 * @param {Object} [options] Options object.
	 * @param {boolean} [options.validate=true] Whether to check if `value` conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @returns {Map} `this`
	 * @example
	 * map.setPaintProperty('my-layer', 'fill-color', '#faafee');
	 * @see [Change a layer's color with buttons](https://docs.track-asia.com/example/color-switcher/)
	 * @see [Create a draggable point](https://docs.track-asia.com/example/drag-a-point/)
	 */
	 ...
	 * @param {*} value The value of the layout property. Must be of a type appropriate for the property, as defined in the [TrackAsia Style Specification](https://docs.track-asia.com/style/).
	 * @param {Object} [options] Options object.
	 * @param {boolean} [options.validate=true] Whether to check if `value` conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @returns {Map} `this`
	 * @example
	 ...
	 *
	 * @param glyphsUrl Glyph URL to set. Must conform to the [TrackAsia Style Specification](https://docs.track-asia.com/style/glyphs/).
	 * @param {StyleSetterOptions} [options] Options object.
	 * @param {boolean} [options.validate=true] Whether to check if the filter conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @returns {Map} `this`
	 * @example
	 * map.setGlyphs('https://docs.track-asia.com/demotiles/font/{fontstack}/{range}.pbf');
	 */
	 ...
	 *
	 * @param light Light properties to set. Must conform to the [TrackAsia Style Specification](https://docs.track-asia.com/style/#light).
	 * @param {Object} [options] Options object.
	 * @param {boolean} [options.validate=true] Whether to check if the filter conforms to the TrackAsia Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
	 * @returns {Map} `this`
	 * @example
	 ...
	 * - For vector or GeoJSON sources, using the [`promoteId`](https://docs.track-asia.com/style/sources/#vector-promoteId) option at the time the source is defined.
	 * - For GeoJSON sources, using the [`generateId`](https://docs.track-asia.com/style/sources/#geojson-generateId) option to auto-assign an `id` based on the feature's index in the source data. If you change feature data using `map.getSource('some id').setData(..)`, you may need to re-apply state taking into account updated `id` values.
	 *
	 * _Note: You can use the [`feature-state` expression](https://docs.track-asia.com/style/expressions/#feature-state) to access the values in a feature's state object for the purposes of styling._
	 *
	 ...
	 * Features are identified by their `feature.id` attribute, which can be any number or string.
	 *
	 * _Note: To access the values in a feature's state object for the purposes of styling the feature, use the [`feature-state` expression](https://docs.track-asia.com/style/expressions/#feature-state)._
	 *
	 * @param {Object} feature Feature identifier. Feature objects returned from
	 * {@link Map#queryRenderedFeatures} or event handlers can be used as feature identifiers.
	 * @param {string | number} feature.id Unique id of the feature.
	 ...
	 * @example
	 * map.triggerRepaint();
	 * @see [Add a 3D model](https://docs.track-asia.com/example/add-3d-model/)
	 * @see [Add an animated icon to the map](https://docs.track-asia.com/example/add-image-animated/)
	 */
	triggerRepaint(): void;
...
export declare class Popup extends Evented {
	 ...
	 *   .addTo(map);
	 * @see [Display a popup](https://docs.track-asia.com/example/popup/)
	 * @see [Display a popup on hover](https://docs.track-asia.com/example/popup-on-hover/)
	 * @see [Display a popup on click](https://docs.track-asia.com/example/popup-on-click/)
	 * @see [Show polygon information on click](https://docs.track-asia.com/example/polygon-popup-on-click/)
	 */
	addTo(map: Map): this;
	/**
	 ...
	 * @example
	 * var popup = new trackasiagl.Popup({ closeOnClick: false, closeButton: false })
	 ...
	 * @see [Display a popup on hover](https://docs.track-asia.com/example/popup-on-hover/)
	 * @see [Display a popup on click](https://docs.track-asia.com/example/popup-on-click/)
	 * @see [Attach a popup to a marker instance](https://docs.track-asia.com/example/set-popup/)
	 */
...
export declare class Marker extends Evented {
	 ...
	 *   .addTo(map);
	 * @see [Add custom icons with Markers](https://docs.track-asia.com/example/custom-marker-icons/)
	 * @see [Create a draggable Marker](https://docs.track-asia.com/example/drag-a-marker/)
	 */
	setLngLat(lnglat: LngLatLike): this;
	/**
	 ...
	 * var marker = new trackasiagl.Marker()
	 *  .setLngLat([0, 0])
	 *  .setPopup(new trackasiagl.Popup().setHTML("<h1>Hello World!</h1>")) // add popup
	 *  .addTo(map);
	 * @see [Attach a popup to a marker instance](https://docs.track-asia.com/example/set-popup/)
	 */
	 ...
	 * var marker = new trackasiagl.Marker()
	 *  .setLngLat([0, 0])
	 *  .setPopup(new trackasiagl.Popup().setHTML("<h1>Hello World!</h1>"))
	 *  .addTo(map);
	 *
...
export declare class GeolocateControl extends Evented implements IControl {
	 ...
	 * var geolocate = new trackasiagl.GeolocateControl({
	 *  positionOptions: {
...
declare const exported: {
	 ...
	 * times in some situations. `trackasiagl.workerUrl` and `trackasiagl.workerCount`, if being
	 ...
	 * `trackasiagl.clearPrewarmedResources()`. This is only necessary if your web page remains
	...
	/**
	 * Clears up resources that have previously been created by `trackasiagl.prewarm()`.
	 ...
	 * @example
	 * trackasiagl.clearPrewarmedResources()
	 */
	 ...
	 * trackasiagl.addProtocol('custom', (params, callback) => {
	 ...
	 * trackasiagl.addProtocol('custom2', (params, callback) => {
	 ...
	 * @example
	 * trackasiagl.removeProtocol('custom');
	 */
