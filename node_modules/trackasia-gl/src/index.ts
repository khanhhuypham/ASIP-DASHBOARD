 ...
 * @example
 * trackasiagl.setRTLTextPlugin('https://unpkg.com/@mapbox/mapbox-gl-rtl-text@0.2.3/mapbox-gl-rtl-text.js');
 * @see [Add support for right-to-left scripts](https://docs.track-asia.com/example/mapbox-gl-rtl-text/)
 */
