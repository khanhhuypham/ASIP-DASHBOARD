 ...
 * (See the [Style Specification](https://docs.track-asia.com/style/#sources-geojson) for detailed documentation of options.)
 *
 * @example
 ...
 * @see [Add a GeoJSON line](https://docs.track-asia.com/example/geojson-line/)
 * @see [Create a heatmap from points](https://docs.track-asia.com/example/heatmap/)
