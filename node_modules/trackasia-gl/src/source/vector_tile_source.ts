 ...
 * (See the [Style Specification](https://docs.track-asia.com/style/) for detailed documentation of options.)
 *
 * @example
 ...
 *
 * @example
 * map.getSource('some id').setUrl("https://docs.track-asia.com/demotiles/tiles/tiles.json");
 *
 * @example
 * map.getSource('some id').setTiles(['https://d25uarhxywzl1j.cloudfront.net/v0.1/{z}/{x}/{y}.mvt']);
 * @see [Add a vector tile source](https://docs.track-asia.com/example/vector-source/)
 * @see [Add a third party vector tile source](https://docs.track-asia.com/example/third-party/)
 */
