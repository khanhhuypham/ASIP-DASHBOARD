 ...
 * (See the [Style Specification](https://docs.track-asia.com/style/#sources-video) for detailed documentation of options.)
 *
 * @example
 * // add to map
 ...
 * @see [Add a video](https://docs.track-asia.com/example/video-on-a-map/)
 */
