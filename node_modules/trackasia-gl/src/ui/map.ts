 ...
 * @param {number} [options.minPitch=0] The minimum pitch of the map (0-85). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the TrackAsia project.
 * @param {number} [options.maxPitch=60] The maximum pitch of the map (0-85). Values greater than 60 degrees are experimental and may result in rendering issues. If you encounter any, please raise an issue with details in the TrackAsia project.
 * @param {Object|string} [options.style] The map's TrackAsia style. This must be an a JSON object conforming to
 * the schema described in the [TrackAsia Style Specification](https://docs.track-asia.com/style/), or a URL to
 * such JSON.
 *
 *
 ...
 * @param {boolean} [options.maplibreLogo=false] If `true`, the TrackAsia logo will be shown.
 * @param {string} [options.logoPosition='bottom-left'] A string representing the position of the TrackAsia wordmark on the map. Valid options are `top-left`,`top-right`, `bottom-left`, `bottom-right`.
 * @param {boolean} [options.failIfMajorPerformanceCaveat=false] If `true`, map creation will fail if the performance of TrackAsia
 ...
 * The purpose of this option is to avoid bandwidth-intensive glyph server requests. (See [Use locally generated ideographs](https://docs.track-asia.com/example/local-ideographs).)
 ...
 *   }
 * });
 * @see [Display a map](https://docs.track-asia.com/example/simple-map/)
 */
class Map extends Camera {
    ...
    */
    ...
    _setupCooperativeGestures() {
        const container = this._container;
        this._cooperativeGesturesScreen = DOM.create('div', 'trackasiagl-cooperative-gesture-screen', container);
        ...
        this._cooperativeGesturesScreen.innerHTML = `
            <div class="trackasiagl-desktop-message">${desktopMessage}</div>
            <div class="trackasiagl-mobile-message">${mobileMessage}</div>
        `;
        ...
        this._canvasContainer.classList.add('trackasiagl-cooperative-gestures');
    }
    ...
    _destroyCooperativeGestures() {
        ...
        this._canvasContainer.classList.remove('trackasiagl-cooperative-gestures');
    }
    ...
    _onCooperativeGesture(event: any, metaPress, touches) {
        if (!metaPress && touches < 2) {
            ...
            this._cooperativeGesturesScreen.classList.add('trackasiagl-show');
            setTimeout(() => {
                this._cooperativeGesturesScreen.classList.remove('trackasiagl-show');
            }, 100);
        }
        return false;
    }
